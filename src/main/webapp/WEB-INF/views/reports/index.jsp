        ...
        <table id="report_list">
            <tbody>
                <tr>
                    ...
                    <th class="report_attendanceAtwork">出勤時間</th>
                    <th class="report_leavingWork">退勤時間</th>
                ...
                <c:forEach var="report" items="${reports}" varStatus="status">
                    ...
                    <td class="report_attendanceAtwork"><fmt:formatDate value="${attendanceAtworkDay}"
                            pattern="yyyy-MM-dd HH:mm" /></td>


                         <fmt:parseDate value="${report.leavingWork}"
                        pattern="yyyy-MM-dd'T'HH:mm" var="leavingWorkDay" type="date" />
                    <td class="report_leavingWork"><fmt:formatDate value="${leavingWorkDay}"
                            pattern="yyyy-MM-dd HH:mm" /></td>
